...
export class MultiRegionS3CrrKmsCmkSourceStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props: S3StaticMultiRegionSourceStackProps) {
    super(scope, id, props);

    // The code that defines your stack goes here
    
    const myTargetConstruct = new MultiRegionS3CrrKmsCmkSource(this, 'MySource', {
